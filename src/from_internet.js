...
function visualize() {
  ...
  switch (visualizerSettings.color) {
    ...
    case 'esa':
    case 'esa2':
      grad = ctx.createLinearGradient(visualizerSettings.reverseRainbow ? canvas.width : 0, 0,
                                      visualizerSettings.reverseRainbow ? 0 : canvas.width, 0);
      if (visualizerSettings.color === 'esa') {
        grad.addColorStop(0, 'rgb(0, 128, 192)')
        grad.addColorStop(1/5, 'rgb(0, 0, 255)')
        grad.addColorStop(2/5, 'rgb(255, 0, 255)')
        grad.addColorStop(3/5, 'rgb(0, 255, 0)')
        grad.addColorStop(4/5, 'rgb(255, 255, 0)')
        grad.addColorStop(1, 'rgb(255, 128, 0)')
      }
      else if (visualizerSettings.color === 'esa2') {
      ...
      ctx.fillStyle = grad;
      peakColor = visualizerSettings.color === 'esa' ? '#808080' : visualizerSettings.darkMode ? '#fff' : '#000';
      break;
    case 'prism':
    case 'prism 2':
    case 'prism 3':
